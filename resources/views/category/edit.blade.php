        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- Header dengan Ikon Back (Sama dengan Create) --}}
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Update the details of your category</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('category.update', $category->id) }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $category->name) }}"
                                ...
                                focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition" required>
